...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Vehicle Addition.create': {
    roles: ['owner', 'admin', 'business-owner'],
    key: 'vehicle_addition',
    tenantPath: [],
    userPath: [],
  },
  'Maintenance Schedule Update.update': {
    roles: ['owner', 'fleet-manager', 'business-owner'],
    key: 'maintenance_schedule_update',
    tenantPath: [],
    userPath: [],
  },
  'New Booking.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'business-owner'],
    key: 'new_booking',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'fleet-manager', 'admin', 'business-owner'];
